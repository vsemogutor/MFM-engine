package arena
{
	...
	public final class CustomModelsRepository
	{
		public function init(game:Game, typesRepository:TypesRepository):void
		{
			...
			unitSprite = game.spriteRepository.getByName("UnitSkeleton") as UnitSprite;
			unitSprite = game.spriteRepository.addRecoloredUnitSprite("UnitUndeadKingNormal", unitSprite, 1.2, 0.2, 0.2, 0.9);	
			game.spriteRepository.addGlowUnitSprite("UnitUndeadKing", unitSprite, 0xFF0000, 0.4, 8);
			
			unitSprite = game.spriteRepository.getByName("UnitSkeletonSword") as UnitSprite;
			game.spriteRepository.addRecoloredUnitSprite("UnitUndeadKingMinion", unitSprite, 0.1, 0.1, 0.1, 1);	

			unitSprite = game.spriteRepository.getByName("UnitWisp") as UnitSprite;
			game.spriteRepository.addRecoloredUnitSprite("UnitWispWhite", unitSprite, 3, 3, 0.8, 0.9);	
			...
			sprite = game.spriteRepository.getByName("EffectHeal");
			game.spriteRepository.addRecoloredSprite("EffectBlackSparks", sprite, -150, -150, -150, 0.95, true);
			
			sprite = game.spriteRepository.getByName("EffectHealthRune");
			game.spriteRepository.addRecoloredSprite("EffectManaRune", sprite, 0, -50, 200, 0.9, true);
